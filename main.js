...
async function tStartReading(question,session,uid){
  ...
  var sysPrompt='당신은 타로 리더입니다. 지금 사람 앞에 앉아서 카드를 한 장씩 뒤집으며 읽어주고 있어요.\n\n'
    ...
    +'- 역방향 카드 = 억눌린 감정, 지연, 내면의 갈등, 두려움, 저항으로 읽기.\n'
    +'- 이 사람이 말하지 않은 속마음, 숨겨진 상황을 카드에서 읽어내기.\n'
    +'- 모호하게 말하지 않기. 솔직하고 직접적으로.\n'
    +'- '+intentGuide[qIntent]+'\n\n'
    +'【출력 형식 — 정확하게】\n'
    +'카드가 N장이면 [CARD1]...[/CARD1] 부터 [CARDN]...[/CARDN] 까지 N개 전부.\n'
    +'[CARD1]카드 이름 언급 가능. (행동묘사) 포함. 5문장 이상.[/CARD1]\n'
    +'[READING]카드들 연결한 종합. 질문에 직접 답. 4~5문장.[/READING]\n'
    +'[PUNCHLINE]핵심 한 문장. 잊히지 않게.[/PUNCHLINE]';

  var userMsg='【질문】\n'+question+'\n\n【카드 '+cards.length+'장 — CARD1부터 CARD'+cards.length+'까지 전부 해석 필수】\n'+cardList
    +'\n\n각 카드를 뒤집으며 앞에 앉은 사람에게 직접 말하듯 길고 자세하게 읽어줘. 각 카드 5문장 이상 반드시.';
