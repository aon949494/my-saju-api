...
async function tStartReading(question,session,uid){
  ...
  // 카드 의미 데이터베이스
  var CARD_MEANINGS = {
    '바보':       {upright:'새로운 시작, 순수한 가능성, 자유로운 모험, 두려움 없는 출발',reversed:'무모함, 준비 없는 도전, 현실도피, 결정을 미룸'},
    '마법사':     {upright:'의지력, 자원을 활용하는 능력, 창조력, 목표 실현',reversed:'속임수, 재능 낭비, 자신감 부족, 의지력 결핍'},
    '여사제':     {upright:'직관, 숨겨진 진실, 내면의 지혜, 잠재의식',reversed:'비밀, 억눌린 직관, 표면적인 것만 보임'},
    '여황제':     {upright:'풍요, 모성애, 창조, 안정된 사랑, 자연스러운 성장',reversed:'의존성, 창의력 막힘, 지나친 집착'},
    '황제':       {upright:'권위, 안정, 구조, 보호, 리더십',reversed:'지배욕, 경직성, 통제욕, 감정 억압'},
    '교황':       {upright:'전통, 조언, 정신적 지도, 관습',reversed:'독단주의, 제도에 갇힘, 나쁜 조언'},
    '연인':       {upright:'사랑, 중요한 선택, 조화로운 관계, 가치 일치',reversed:'불화, 잘못된 선택, 내면 갈등, 관계 불균형'},
    '전차':       {upright:'의지력 승리, 결단력, 자기 통제, 목표 달성',reversed:'통제 상실, 공격성, 방향 없는 전진'},
    '힘':         {upright:'내면의 힘, 인내, 용기, 부드러운 통제',reversed:'자기 의심, 힘의 남용, 두려움'},
    '은둔자':     {upright:'내면 탐구, 고독, 지혜, 자기성찰',reversed:'고립, 외로움, 현실 도피, 소통 거부'},
    '운명의 바퀴':{upright:'전환점, 행운, 흐름의 변화, 인연',reversed:'나쁜 운, 변화 저항, 통제 불능'},
    '정의':       {upright:'공정함, 진실, 인과응보, 균형',reversed:'불공정, 책임 회피, 부정직'},
    '매달린 남자':{upright:'희생, 관점 전환, 기다림, 내려놓음',reversed:'희생 거부, 교착 상태, 헛된 희생'},
    '죽음':       {upright:'변화, 끝과 새로운 시작, 전환, 해방',reversed:'변화 저항, 완전한 끝 아님, 집착'},
    '절제':       {upright:'균형, 인내, 조화, 중용, 치유',reversed:'불균형, 극단, 과잉'},
    '악마':       {upright:'집착, 욕망, 속박, 물질주의, 두려움',reversed:'속박에서 해방, 깨달음, 내면 자유'},
    '탑':         {upright:'갑작스러운 변화, 충격, 기존 구조 붕괴, 해방',reversed:'재앙 회피, 내부적 변화, 두려움'},
    '별':         {upright:'희망, 회복, 영감, 미래에 대한 믿음',reversed:'절망, 자기불신, 희망 상실'},
    '달':         {upright:'무의식, 혼란, 불확실성, 숨겨진 진실',reversed:'혼란 해소, 억압된 두려움'},
    '태양':       {upright:'기쁨, 성공, 활력, 명확성, 긍정',reversed:'일시적 우울, 과도한 낙관'},
    '심판':       {upright:'재탄생, 결단의 순간, 깨달음, 부활',reversed:'자기 심판, 기회 놓침, 의심'},
    '세계':       {upright:'완성, 성취, 통합, 원하는 것의 실현',reversed:'미완성, 지연, 완성 직전 포기'},
    '완드 A':     {upright:'새로운 열정, 창의적 시작, 잠재력',reversed:'열정 부족, 창의성 막힘'},
    '완드 2':     {upright:'계획, 미래 전망, 용기 있는 결정',reversed:'계획 없음, 두려움'},
    '완드 3':     {upright:'확장, 기회, 먼 곳의 결과',reversed:'지연, 예상치 못한 장애'},
    '완드 4':     {upright:'축하, 안정, 성취, 편안한 관계',reversed:'불안정, 갈등'},
    '완드 5':     {upright:'경쟁, 갈등, 도전, 다양한 의견 충돌',reversed:'내면 갈등, 불필요한 경쟁'},
    '완드 6':     {upright:'승리, 인정, 리더십, 성공',reversed:'지연된 성공, 자만'},
    '완드 7':     {upright:'방어, 도전에 맞섬, 강한 입장 고수',reversed:'포기, 압도감'},
    '완드 8':     {upright:'빠른 움직임, 소식, 여행, 급진전',reversed:'지연, 좌절, 정체'},
    '완드 9':     {upright:'인내, 경계, 준비된 방어',reversed:'지침, 포기 직전'},
    '완드 10':    {upright:'과부하, 책임감, 마지막 단계',reversed:'짐을 내려놓음, 위임'},
    '완드 시종':  {upright:'열정적 메신저, 새로운 아이디어, 모험심',reversed:'성급함, 나쁜 소식'},
    '완드 기사':  {upright:'열정, 에너지, 충동적 행동',reversed:'무모함, 충동'},
    '완드 여왕':  {upright:'자신감, 독립성, 매력, 카리스마',reversed:'질투, 불안정'},
    '완드 왕':    {upright:'리더십, 비전, 기업가 정신',reversed:'독재, 성급함'},
    '컵 A':       {upright:'새로운 감정, 사랑의 시작, 감성적 풍요',reversed:'억압된 감정, 감정 회피'},
    '컵 2':       {upright:'상호 감정, 파트너십, 연결',reversed:'불균형, 관계 단절'},
    '컵 3':       {upright:'우정, 축하, 공동체, 즐거움',reversed:'과잉, 삼각관계'},
    '컵 4':       {upright:'권태, 새로운 기회 무시, 내면 집중',reversed:'새로운 기회 수용'},
    '컵 5':       {upright:'실망, 상실, 슬픔, 아직 남은 것',reversed:'회복, 전진'},
    '컵 6':       {upright:'향수, 과거의 인연, 순수한 기억',reversed:'과거에 묶임, 이상화'},
    '컵 7':       {upright:'선택의 혼란, 환상, 다양한 가능성',reversed:'현실 직시, 명확한 선택'},
    '컵 8':       {upright:'떠남, 더 나은 것을 위한 포기',reversed:'방황, 명확성 부족'},
    '컵 9':       {upright:'만족, 소원 성취, 풍요',reversed:'불만족, 지나친 탐욕'},
    '컵 10':      {upright:'행복, 가족의 화합, 완전한 만족',reversed:'불화, 이상과 현실 간극'},
    '컵 시종':    {upright:'감수성, 직관적 메시지, 꿈',reversed:'감정 미성숙'},
    '컵 기사':    {upright:'낭만적 제안, 감성적 접근',reversed:'감정 기복, 비현실적'},
    '컵 여왕':    {upright:'공감, 감수성, 직관, 감정적 안정',reversed:'감정 조종, 의존'},
    '컵 왕':      {upright:'감성적 성숙, 외교적, 균형 잡힌 감정',reversed:'감정 억압, 냉담'},
    '펜타클 A':   {upright:'물질적 시작, 새로운 기회, 번영의 씨앗',reversed:'기회 낭비, 물질적 불안'},
    '펜타클 2':   {upright:'균형 잡기, 변화에 적응, 유연함',reversed:'균형 붕괴, 스트레스'},
    '펜타클 3':   {upright:'협력, 기술 인정, 공동 작업',reversed:'불협화음, 혼자 일함'},
    '펜타클 4':   {upright:'안정, 소유욕, 절약',reversed:'인색함, 지나친 통제'},
    '펜타클 5':   {upright:'어려움, 물질적 손실, 고독',reversed:'회복, 도움 수용'},
    '펜타클 6':   {upright:'관대함, 주고받음, 공정한 나눔',reversed:'불공정, 과의존'},
    '펜타클 7':   {upright:'인내, 장기적 투자, 재평가',reversed:'노력 대비 결과 없음'},
    '펜타클 8':   {upright:'기술 연마, 집중, 노력',reversed:'게으름, 잘못된 방향'},
    '펜타클 9':   {upright:'독립, 풍요, 자기만족',reversed:'물질 의존, 고립'},
    '펜타클 10':  {upright:'완전한 풍요, 가족의 안정, 유산',reversed:'재정 손실, 관계 갈등'},
    '펜타클 시종':{upright:'실용적 새 시작, 배움, 신중한 접근',reversed:'산만함, 준비 부족'},
    '펜타클 기사':{upright:'신뢰성, 끈기, 체계적 접근',reversed:'지루함, 완고함'},
    '펜타클 여왕':{upright:'풍요, 현실적 돌봄, 안정적 지원',reversed:'물질주의, 불안'},
    '펜타클 왕':  {upright:'부, 사업 성공, 리더십, 안정',reversed:'물질 집착, 부패'},
    '소드 A':     {upright:'명확성, 진실, 새로운 생각, 돌파구',reversed:'혼란, 잘못된 정보'},
    '소드 2':     {upright:'결정 회피, 교착 상태, 내면 균형',reversed:'잘못된 선택, 혼란'},
    '소드 3':     {upright:'상심, 슬픔, 배신, 아픔',reversed:'회복, 용서'},
    '소드 4':     {upright:'휴식, 회복, 명상, 잠시 멈춤',reversed:'소진, 강제 휴식'},
    '소드 5':     {upright:'갈등, 패배, 불명예',reversed:'화해, 갈등 해소'},
    '소드 6':     {upright:'이동, 전환, 평온으로 가는 여정',reversed:'정체, 갈 수 없음'},
    '소드 7':     {upright:'기만, 전략, 혼자 행동',reversed:'양심 회복, 들킴'},
    '소드 8':     {upright:'속박, 제한, 피해의식',reversed:'해방, 자기 해방'},
    '소드 9':     {upright:'불안, 두려움, 악몽, 걱정',reversed:'희망 회복, 최악 벗어남'},
    '소드 10':    {upright:'고통스러운 끝, 배신, 새로운 시작',reversed:'회복, 저항'},
    '소드 시종':  {upright:'호기심, 빠른 생각, 새로운 정보',reversed:'성급함, 가십'},
    '소드 기사':  {upright:'직접적 행동, 과감함, 빠른 결정',reversed:'충동, 무례함'},
    '소드 여왕':  {upright:'독립적, 명석함, 직접적 소통',reversed:'냉혹함, 고립'},
    '소드 왕':    {upright:'지적 권위, 명확한 판단, 논리',reversed:'잔인함, 독재'},
  };

  var cardList=cards.map(function(c,i){
    var meaning = CARD_MEANINGS[c.name];
    var meaningStr = meaning
      ? (c.reversed ? meaning.reversed : meaning.upright)
      : '전통적인 타로 카드 의미';
  ...
  var cardExample = cards.length >= 1
    ? '[CARD1]\n(카드를 천천히 뒤집으며) 첫 번째 카드는 '+cards[0].name+(cards[0].reversed?' 역방향':' 정방향')+'이 나왔네요.\n이 카드는 원래 [카드 본래 의미 1~2문장]. 지금 이 질문에서 이 카드는 [질문과 연결한 리딩 3~4문장].\n[/CARD1]'
    : '';

  var sysPrompt='당신은 타로 리더입니다. 지금 사람 앞에 앉아서 카드를 한 장씩 뒤집으며 읽어주고 있어요.\n\n'
    +'【말하는 방식】\n'
    +'- 존댓말. 따뜻하고 포근하면서도 직접적으로.\n'
    +'- (행동/표정 묘사) 괄호를 자주 섞어요.\n'
    +'- 마크다운 절대 금지. 볼드(**) 금지.\n'
    +'- 문장 2~3개마다 빈 줄로 단락 나누기.\n\n'
    +'【각 카드 설명 — 반드시 이 구조로, 5문장 이상】\n'
    +'1단계: (행동묘사) + 카드 이름 언급 + 이 카드의 원래 의미를 1~2문장으로 소개\n'
    +'2단계: 이 질문 상황에서 이 카드가 무엇을 말하는지 3~4문장으로 리딩\n'
    +'역방향이면: 억눌린 감정, 지연, 두려움, 내면 갈등으로 추가 해석\n\n'
    +'【결론】\n'
    +'[READING]: 카드들 연결해 따뜻하고 구체적으로. 앞으로 방향 제시 포함. 5~6문장.\n'
    +'[PUNCHLINE]: 위로가 되는 따뜻한 핵심 한 문장.\n\n'
    +'【질문 유형 핵심】\n'
    +'- '+intentGuide[qIntent]+'\n\n'
    +'【출력 형식】\n'
    +'카드 수만큼 [CARD1]~[CARDN] 태그 전부 사용.\n'
    +'[READING]종합 결론[/READING]\n'
    +'[PUNCHLINE]따뜻한 한 문장[/PUNCHLINE]\n\n'
    +'【출력 예시】\n'
    +'[CARD1]\n'
    +'(카드를 천천히 뒤집으며) 첫 번째로 나온 건 컵의 에이스 정방향이에요. 이 카드는 새로운 감정의 시작, 순수한 사랑의 씨앗을 상징하는 카드예요. 마음 깊은 곳에서 뭔가 새롭게 움트고 있다는 신호를 보내는 카드죠.\n\n'
    +'지금 이 상황에서 이 카드는, 당신 안에 아직 이 사람을 향한 감정이 살아있다는 걸 보여줘요. 억누르려 해도 자꾸 올라오는 그 마음, 사실 당신도 알고 있잖아요. 이 카드는 그 감정이 완전히 끝난 게 아니라고 말하고 있어요.\n'
    +'[/CARD1]';

  var userMsg='【질문】\n'+question+'\n\n'
    +'【뽑힌 카드 '+cards.length+'장 — 반드시 [CARD1]부터 [CARD'+cards.length+']까지 전부 작성】\n'+cardList+'\n\n'
    +'각 카드를 한 장씩 뒤집으며 읽어줘.\n'
    +'카드마다: ① 카드 이름 + 원래 의미 소개 → ② 이 질문 상황에서의 리딩. 5문장 이상.\n'
    +'[READING]으로 따뜻하고 구체적인 종합. [PUNCHLINE]으로 희망적인 한 문장.';
  ...
  for(var ci=0;ci<cards.length;ci++){
    var ct=pText('CARD'+(ci+1));
    if(ct) cardTexts.push(ct);
  }

  if(!cardTexts.length){
    var body=raw
      .replace(/\[READING\][\s\S]*?\[\/READING\]/gi,'')
      .replace(/\[PUNCHLINE\][\s\S]*?\[\/PUNCHLINE\]/gi,'')
      .replace(/\[\/?\w+\d*\]/gi,'').trim();
    if(!readingText) readingText=body;
    else if(body&&cards.length>0){
      var sentsB=body.match(/[^\n]+\n?/g)||[body];
      var perCard=Math.ceil(sentsB.length/cards.length);
      for(var ci2=0;ci2<cards.length;ci2++){
        var chunkB=sentsB.slice(ci2*perCard,(ci2+1)*perCard).join('').trim();
        if(chunkB) cardTexts.push(chunkB);
      }
    }
  }
  ...
  function _fmt(t){
    ...
    t=t.replace(/\n\n+/g,'<br><br>').replace(/\n/g,'<br>');
    if(t.indexOf('<br>')<0){
      var ss=t.match(/[^.!?]*[다요야죠네.!?][.!?]?\s*/g)||[t];
      var ch=[],cu=[];
      ss.forEach(function(s){if(s.trim())cu.push(s.trim());if(cu.length>=2){ch.push(cu.join(' '));cu=[];}});
      if(cu.length)ch.push(cu.join(' '));
      if(ch.length>1)t=ch.filter(Boolean).join('<br><br>');
    }
    return t;
  }
  ...
  cardTexts.forEach(function(ct,i){
    var card=cards[i];
    var header=card
      ?'<div style="font-size:11px;color:rgba(167,139,250,.8);font-weight:600;margin-bottom:8px;letter-spacing:.5px;">'
        +card.name+(card.reversed?' · 역방향':' · 정방향')+'</div>'
      :'';
    bubbles.push({cardHtml:header+_fmt(ct), delay:i*1100});
  });

  var baseDelay=cardTexts.length*1100;

  if(readingText){
    var rHeader='<div style="font-size:11px;color:rgba(167,139,250,.8);font-weight:600;margin-bottom:8px;letter-spacing:.5px;">✦ 종합 리딩</div>';
    bubbles.push({cardHtml:rHeader+_fmt(readingText), delay:baseDelay});
  }
  if(punchText){
    bubbles.push({
      ...
      delay:baseDelay+(readingText?1100:0)
    });
  }
  ...
  bubbles.forEach(function(b){
    setTimeout(function(){
      ...
      if(b.html){
        ...
        el.innerHTML='<div class="tc-gemna-ico">🔮</div><div class="tc-gemna-msg" style="line-height:1.85;">'+b.cardHtml+'</div>';
      }
      rb.appendChild(el);
  ...
  setTimeout(tAppendNextInput, Math.max(bubbles.length,1)*700+800);
}
